...
T = TypeVar("T", bound="JSONResponseModelListContactPublic")


@_attrs_define
class JSONResponseModelListContactPublic:
    """
    Attributes:
        data (Union[Unset, list[list['ContactPublic']]]):
        count (Union[None, Unset, int]):
        success (Union[Unset, bool]):  Default: True.
        error (Union[None, Unset, str]):
    """

    data: Union[Unset, list[list["ContactPublic"]]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            ...
            for data_item_item_data in _data_item:
                data_item_item = ContactPublic.from_dict(data_item_item_data)
        ...
        json_response_model_list_contact_public = cls(
            data=data,
            count=count,
            success=success,
            error=error,
        ...
        json_response_model_list_contact_public.additional_properties = d
        return json_response_model_list_contact_public
