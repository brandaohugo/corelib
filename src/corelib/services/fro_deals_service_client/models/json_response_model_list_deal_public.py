...
if TYPE_CHECKING:
    from ..models.deal_public import DealPublic


T = TypeVar("T", bound="JSONResponseModelListDealPublic")


@_attrs_define
class JSONResponseModelListDealPublic:
    """
    Attributes:
        data (Union[Unset, list[list['DealPublic']]]):
        count (Union[None, Unset, int]):
        success (Union[Unset, bool]):  Default: True.
        error (Union[None, Unset, str]):
    """

    data: Union[Unset, list[list["DealPublic"]]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            ...
            for data_item_item_data in _data_item:
                data_item_item = DealPublic.from_dict(data_item_item_data)
        ...
        json_response_model_list_deal_public = cls(
            data=data,
            count=count,
            success=success,
            error=error,
        ...
        json_response_model_list_deal_public.additional_properties = d
        return json_response_model_list_deal_public
