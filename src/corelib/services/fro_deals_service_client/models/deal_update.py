...
if TYPE_CHECKING:
    from ..models.deal_update_fields import DealUpdateFields


T = TypeVar("T", bound="DealUpdate")
...
class DealUpdate:
    ...
    Attributes:
        ...
        fields (Union[Unset, DealUpdateFields]):
    """
    ...
    fields: Union[Unset, "DealUpdateFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_fields, Unset):
            ...
            fields = DealUpdateFields.from_dict(_fields)
        ...
        deal_update.additional_properties = d
        return deal_update
