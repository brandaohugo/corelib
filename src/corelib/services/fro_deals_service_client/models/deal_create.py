...
if TYPE_CHECKING:
    from ..models.deal_create_fields import DealCreateFields


T = TypeVar("T", bound="DealCreate")
...
class DealCreate:
    ...
    Attributes:
        ...
        fields (Union[Unset, DealCreateFields]):
    """
    ...
    fields: Union[Unset, "DealCreateFields"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_fields, Unset):
            ...
            fields = DealCreateFields.from_dict(_fields)
        ...
        deal_create.additional_properties = d
        return deal_create
